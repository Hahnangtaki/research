package id.co.research.relation.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("RelationInOneTable");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("RelationInOneTable");
        ...
        config.getMapConfigs().put("id.co.research.relation.domain.*", initializeDomainMapConfig(jHipsterProperties));
